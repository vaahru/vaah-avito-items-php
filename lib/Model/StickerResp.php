 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StickerResp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StickerResp';
     ...
     * Sets description
     *
     * @param string $description Описание значка
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param int $id Идентификатор значка
     *
     * @return $this
     */
     ...
     * Sets title
     *
     * @param string $title Название значка
     *
     * @return $this
     */
