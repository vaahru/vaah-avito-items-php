...
/**
 * CallsStatsRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallsStatsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallsStatsRequest';
     ...
     * Sets date_from
     *
     * @param string $date_from Начальная дата периода (YYYY-MM-DD)
     *
     * @return $this
     */
     ...
     * Sets date_to
     *
     * @param string $date_to Конечная дата периода (YYYY-MM-DD)
     *
     * @return $this
     */
     ...
     * Sets item_ids
     *
     * @param int[] $item_ids Идентификаторы объявлений
     *
     * @return $this
     */
