...
/**
 * ItemIdVasBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemIdVasBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'itemId_vas_body';
    ...
    {
        $this->container['slugs'] = isset($data['slugs']) ? $data['slugs'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['slugs'] === null) {
            $invalidProperties[] = "'slugs' can't be null";
        }
    ...
    {
        return $this->container['slugs'];
    }

    /**
     * Sets slugs
     *
     * @param string[] $slugs Список идентификаторов услуг
     *
     * @return $this
     */
    public function setSlugs($slugs)
    {
        $this->container['slugs'] = $slugs;
     ...
     * Sets stickers
     *
     * @param int[] $stickers Список значков
     *
     * @return $this
     */
